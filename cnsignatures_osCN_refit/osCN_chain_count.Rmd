...
suppressMessages(Heatmap(oldNewSigsCombinedMat,
                         ...
                         cluster_rows = FALSE, column_title = "Combined signature compendium - For reference only",name = "weight"))
```
...
sigDef <- readRDS("data/new_pan_cancer_sig_definition_compendium_tcga_6335.rds")
newActs_NewSig_NewMix_noThresh <- CINSignatureQuantification:::calculateActivityDrewsV2(object = osCN_new_sxc,SIGS = sigDef)
