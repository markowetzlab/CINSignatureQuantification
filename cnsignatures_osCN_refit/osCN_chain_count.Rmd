...
osCN_new_feats <- CINSignatureQuantification::getFeatures(readRDS("data/tcga_6335_cnquant_newweights.rds"))
osCN_new_sxc <- readRDS("data/pan_new_oscn_mixture_tcga_SxC.rds")
osCN_new_models <- CINSignatureQuantification::Drews2022_v2_TCGA_Mixture_Models
...
new_sig19_tcga_thresholds <- estimateThresholds(feats = osCN_new_feats,
                                                ...
                                                iters = 20,method = "drewsV2",cores = 10)
