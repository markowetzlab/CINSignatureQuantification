...
## Clinical classifier and coxPH models

```{r coxPH_CX2CX3-CN2CN3}
## Load data from Rmd MultiFigures_Clinical_classifier
dtSurvOV = readRDS(SURVIVALOV) # Drews2022_CIN_Compendium/Section 9 Building a clin classifier/input/Survival_and_BRCA_Status_TCGA-OV.rds
metaFull = readRDS(META) # Drews2022_CIN_Compendium/Section 9 Building a clin classifier/input/Metadata_TCGA_ASCAT_penalty70.rds
...
resCoxOS2 = coxph(Surv(OS.time, OS) ~ CN1 + CN2 + CN3 + CN4 + CN5 + CN6 + CN7 + CN8 + CN9 + CN10 + CN11  + CN12 + CN13 + CN14 + CN15 + CN16 + CN17 + CN18 + CN19 + Age + Race + TS, data =  dtOV)
pCoxOS2 = ggforest(resCoxOS2, data = dtOV, main = "Cox HR model for TCGA-OV OS")

resCoxPFI2 = coxph(Surv(PFI.time, PFI) ~ CN1 + CN2 + CN3 + CN4 + CN5 + CN6 + CN7 + CN8 + CN9 + CN10 + CN11  + CN12 + CN13 + CN14 + CN15 + CN16 + CN17 + CN18 + CN19 + Age + Race + TS, data =  dtOV)
pCoxPFI2 = ggforest(resCoxPFI2, data = dtOV, main = "Cox HR model for TCGA-OV PFI")
