...
rownames(Drews2022_v2_TCGA_Signatures) <- mapping_file_ordered$drews2022_V2[match(prop_ordering,mapping_file_ordered$name)]
...
colnames(ThreshNormaliseNewActs_NewSig_NewMix_ordered) <- mapping_file_ordered$drews2022_V2[match(prop_ordering,mapping_file_ordered$name)]
